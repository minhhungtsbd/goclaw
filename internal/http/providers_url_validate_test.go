...
func TestValidateProviderURL(t *testing.T) {
	...
	tests := []struct {
		...
		{"antigravity host bridge", "http://host.docker.internal:18891/v1", "antigravity_cli_host", false},
		...
		{"antigravity private service", "http://postgres:5432/v1", "antigravity_cli_host", true},
