...
- Nếu khách đã kết nối lại và đổi Region hợp lý nhưng vẫn lỗi lặp lại, xin dữ kiện không nhạy cảm cần thiết (email Cloudmini, thời điểm lỗi, Country/State/City/TTL đã chọn và ảnh mã lỗi nếu có) rồi chuyển Admin/Kỹ thuật kiểm tra. Không yêu cầu hoặc ghi lại chuỗi `host:port:user:pass`.
